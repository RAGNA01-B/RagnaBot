...
conn.reply(m.chat, `${mid.buscador9}\n\n` + res.result.isi, fkontak, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: '𝙍𝘼𝙂𝙉𝘼𝘽𝙊𝙏 | 𝙒𝙞𝙠𝙞𝙥𝙚𝙙𝙞𝙖', body: '𝙎𝙐𝙋𝙀𝙍 𝙍𝘼𝙂𝙉𝘼𝘽𝙊𝙏 - 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋', previewType: 0, thumbnail: imagen2, sourceUrl: accountsgb }}})
}).catch((e) => {
