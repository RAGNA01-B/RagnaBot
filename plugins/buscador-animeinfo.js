...
//conn.sendFile(m.chat, result.images.jpg.image_url, 'error.jpg', AnimeInfo, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝙎𝙐𝙋𝙀𝙍 𝙍𝘼𝙂𝙉𝘼𝘽𝙊𝙏 - 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}})
