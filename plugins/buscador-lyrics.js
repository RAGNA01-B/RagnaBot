...
//conn.sendFile(m.chat, img, 'letra.jpg', `ღ ${mid.smsYT1} :\n💚 *${result[0].title || ''}*\n\nღ ${mid.smsYT2} :\n💜 *${result[0].artist || ''}*\n\nღ ${mid.smsYT3} :\n${lyrics || ''}`, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝙎𝙐𝙋𝙀𝙍 𝙍𝘼𝙂𝙉𝘼𝘽𝙊𝙏 - 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}})
