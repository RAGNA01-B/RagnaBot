...
[' ArmaBot', `${md}`]], fkontak)
//conn.sendFile(m.chat, gataImg, 'lp.jpg', info, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝙎𝙐𝙋𝙀𝙍 𝙍𝘼𝙂𝙉𝘼𝘽𝙊𝙏 - 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}) 
/*let info = `
╭━━━━[ ${gt} ]━━━━━⬣
┃
┃➥ *CREADORA | CREATOR*
