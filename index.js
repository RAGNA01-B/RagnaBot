...
say(`Creador por Arm y Ragna\nSi eres mi noviecita yane te amo mucho`, {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']})
...
┊${chalk.blueBright('┊')}${chalk.cyan(`😺 Project Author: Arm y Ragna`)}
┊${chalk.blueBright('┊')}${chalk.blueBright('┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')} 
┊${chalk.blueBright('┊')}${chalk.yellow(`💜 Colaboradores:`)}
┊${chalk.blueBright('┊')}${chalk.yellow(`• Arm (+525646809363)`)}
┊${chalk.blueBright('┊')}${chalk.yellow(`• Ragna (+525660166513
)`)}
┊${chalk.blueBright('╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')} 
┊${chalk.blueBright('╭┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')}
