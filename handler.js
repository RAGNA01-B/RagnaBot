...
//this.reply(m.chat, `𝓝𝓞 𝑇𝓘𝓔𝓝𝓔𝓢 ℛ𝓐𝓖𝓝𝓐𝓒𝓞𝓘𝓝𝓢`, m)
this.sendMessage(m.chat, {text: `𝓝𝓞 𝑇𝓘𝓔𝓝𝓔𝓢 ℛ𝓐𝓖𝓝𝓐𝓒𝓞𝓘𝓝𝓢`,  contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: wm, previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb }}}, { quoted: m })         
continue     
}
...
if (m.money)
m.reply(+m.money + 'ℛ𝓐𝓖𝓝𝓐𝓒𝓞𝓘𝓝𝓢 𝓖𝓐𝓢𝑇𝓐𝓓𝓞(𝓢)')  
break
}}} catch (e) {
console.error(e)
} finally {
